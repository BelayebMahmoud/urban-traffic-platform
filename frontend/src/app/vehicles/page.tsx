...
const STATUS_FILTERS: Array<VehicleStatus | 'ALL'> = [
  'ALL',
  'ACTIVE',
  'INACTIVE',
  'MAINTENANCE',
...
export default function VehiclesPage() {
  ...
  return (
    <DashboardLayout>
      <Header
        title="Vehicles"
        subtitle={`${data?.length ?? 0} vehicles registered`}
      />
      ...
      <div className="px-8 py-6">
        ...
        {showForm && (
          <div className="card p-6 mb-6 animate-slide-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              >
                {(['CAR', 'TRUCK', 'BUS', 'MOTORCYCLE'] as VehicleType[]).map(
                  (t) => (
              ...
              >
                {(['ACTIVE', 'INACTIVE', 'MAINTENANCE'] as VehicleStatus[]).map(
                  (s) => (
        ...
        {isLoading ? (
          ...
          <ErrorMessage message="Could not load vehicles." />
        ) : filtered.length === 0 ? (
          <EmptyState
            icon={Car}
